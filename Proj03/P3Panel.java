...
public class P3Panel extends JPanel{
    ...
    private static String[] depts = {"Select One","Art","Biology","Buisness",
                ...
                "Political Science","Undecided","HELP ME!!"};
   ...
   // private JPanel rbPanel = new JPanel();
    ...
    public static int p3ValidateUI(){
	...
	else if(deptCB.getSelectedIndex()==12){return 6;}
        else{return 0;}
    }
    
    public static void p3ClearUI(){
